...
Not a substitute for the NIST CTC / MBE PMI validation models (CLAUDE.md test
data) — these are minimal, self-authored geometries so the pipeline and the
roundtrip test can run without downloading arbitrary STEP files:
