...
# semanticIds verified against IDTA 02006-2-0 (see docs/verification-log.md).
"""
...
logger = logging.getLogger("step2aas.nameplate")
...
def build_nameplate(
    ...
    if not include_incomplete:
        ...
        # invalid, required-field-missing Nameplate.
        logger.warning(
